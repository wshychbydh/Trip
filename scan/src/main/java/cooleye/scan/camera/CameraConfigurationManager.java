...
import cooleye.scan.camera.metering.MeteringInterface;
...
public final class CameraConfigurationManager {
    ...
    void setDesiredCameraParameters(Camera camera, boolean safeMode) {
        ...
        if (prefs.getBoolean(PreferencesKeys.KEY_AUTO_FOCUS, true)) {
            if (safeMode || prefs.getBoolean(PreferencesKeys.KEY_DISABLE_CONTINUOUS_FOCUS, true)) {
    ...
    private void doSetTorch(Camera.Parameters parameters, boolean newSetting, boolean safeMode) {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        if (!prefs.getBoolean(PreferencesKeys.KEY_DISABLE_EXPOSURE, true)) {
            if (!safeMode) {
